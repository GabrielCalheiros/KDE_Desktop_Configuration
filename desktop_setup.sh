...
games=(
   ...
   "2048.c                                 # A terminal 2048 written in c"
   "gnome-2048                             # Obtain the 2048 tile"
   "abuse                                  # Side-scroller action game that pits you against ruthless alien killers"
   "scummvm                                # A virtual machine for several classic graphical point-and-click adventure games."
   "openage                                # A free (as in freedom) clone of the Age of Empires II engine"
   "openspades-git                         # A clone of Voxlap Ace of Spades"
   "spacecadetpinball-git                  # Reverse engineered port of 3D Pinball for Windows – Space Cadet to Linux"
   "ascii-patrol                           # Terminal Moon Control clone."
